...
if (typeof window == 'object') (function (window) {
  ...
  window.showToolbarForNote = function (element, editorialChange, base) {
    ...
    // --- FIX: Handle case where noteProperties is undefined (e.g. invalid nodeName) ---
    if (!noteProperties) {
      console.warn("showToolbarForNote: noteProperties is undefined for element", element.nodeName, element);
      return;
    }
